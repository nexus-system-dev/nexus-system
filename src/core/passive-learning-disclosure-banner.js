...
export function createPassiveLearningDisclosureBanner({
  ...
  const hasInsights = insightItems.length > 0 || typeof normalizedLearningInsights.summary === "string";

  return {
    learningDisclosure: {
      bannerId: `learning-disclosure:${normalizedLearningInsights.insightSetId ?? "nexus"}`,
