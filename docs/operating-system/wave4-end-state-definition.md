...
- להחזיק `generation learning signal integration` גלוי שמוכיח ש־stored learning signals משנים later generation framing / proof focus / primary action לפני שאפשר לטעון ש־generation השתפרה לאורך זמן
